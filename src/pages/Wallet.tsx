    ...
    <>
      <section className="relative overflow-hidden">
        <div className="container-luxe py-24 md:py-32 grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-square bg-onyx-800 overflow-hidden order-last lg:order-first">
      ...
      <section className="container-luxe pb-32">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-px bg-border">
          {features.map((f, i) => (
            <div key={i} className="bg-onyx-900 p-10 md:p-14 hover:bg-onyx-800 transition-colors duration-500">
