  ...
  return (
    <>
      <SEO
        ...
        description="Three thresholds into the Noir/Vault society — Initiate, Sovereign and Noir. Compare benefits, eligibility and the four-stage admittance passage of our invitation-only crypto network."
      />
        ...
        <div className="grid lg:grid-cols-3 gap-px bg-border">
          {tiers.map((t, i) => (
            <Reveal key={i} delay={i * 100}>
              <div
                className={`relative bg-onyx-900 p-10 md:p-12 flex flex-col h-full ${
              ...
              >
                ...
                <t.icon className={t.featured ? "text-primary mb-6" : "text-primary/70 mb-6"} size={28} />
      ...
      <section className="container-luxe pb-32">
        <Reveal>
          <SectionHeader
            ...
            title="A complete comparison of every threshold."
            description="From eligibility floors to the quiet privileges that come with each tier — measured in full transparency."
          />
        </Reveal>
        <div className="mt-16">
          <Reveal>
        ...
        <div className="mt-10 text-center text-xs text-muted-foreground tracking-wide">
          Figures and seat counts current to Cycle MMXXV. All membership is subject to admissions chamber review.
        </div>
      </section>
